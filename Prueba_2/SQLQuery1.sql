...
insert into logDial 
values('197463',	'01-01-2020'	,60,	'8000000001',	'Cel LD'),
('197464',	'02-01-2020',	60,	'8000000002',	'Cel LD'),
('197465',	'03-01-2020',	240,	'8000000003',	'Cel LD'),
('197466',	'04-01-2020',	60,	'8000000004',	'Cel LD');

insert into logDial values
('197467',	'05-01-2020',	60,	'8000000005',	'Cel LD'),
('197468',	'06-01-2020',	60,	'8000000006',	'Cel LD'),
('197469',	'07-01-2020',	60,	'8000000007',	'Cel');

insert into logDial values
('197470',	'08-01-2020',	120,	'8000000008',	'LD nacional'),
('197471',	'09-01-2020',	60,	'8000000009',	'Cel LD'),
('197472',	'10-01-2020',	60,	'8000000010'	,'Cel LD');

insert into logDial values
('197473',	'11-01-2020',	120,	'8000000011',	'Cel LD'),
('197474',	'12-01-2020',	60,	'8000000012',	'LD nacional');
...
select * from logDial where tipoDeLlamada = 'Cel LD' and fechaDeLlamada between '2020/02/01' and '2020/02/29';

-- Que indique el promedio de tiempo de dialogo de las llamadas con tipo Cel LD durante el mes de febrero 

select AVG(tiempoDialogo) as promedio from logDial 
where tipoDeLlamada = 'Cel LD' and fechaDeLlamada between '2020/02/01' and '2020/02/29'; 
...
select (logDial.tiempoDialogo/60) as minutos, costos.costo 
from logDial, costos
where logDial.tipoDeLlamada = costos.tipoDeLlamada
and fechaDeLlamada between '2020/01/01' and '2020/01/31'

select (SUM(tiempoDialogo)/60), ((SUM(tiempoDialogo)/60) * costo)
from logDial, costos 
where logDial.tipoDeLlamada = costos.tipoDeLlamada
